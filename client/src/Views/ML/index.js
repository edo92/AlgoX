                                ...
                                <Col>
                                    <Col>
                                        <Row>
                                            ...
                                            <Col>
                                                <Button onClick={() => this.createDataset()}>Create</Button>
                                            </Col>
                                            <Col>
                                                {this.state.dataset.creating ? <Progress percent={Math.round(this.state.dataset.progress)} status='active' /> : null}
                                            </Col>
                                        </Row>
                                    </Col>
                                    <Col>
                            ...
                            <Card title={
                                <Col>
                                    <Col>
                                        <Row>
                                            ...
                                            <Col>
                                                {this.state.train.creating ? <Progress percent={Math.round(this.state.train.progress)} status='active' /> : null}
                                            </Col>
                                        </Row>
                                    </Col>
                                ...
                                {!this.state.trainSaveMode &&
                                    <Col className='py-3' style={{ height: '280px' }}>
                                        <Row style={{ justifyContent: 'space-evenly' }}>
                                            <Progress type='circle' percent={Math.round(this.state.train.acc * 100)} />
                                            <Progress type='circle' percent={Math.round(this.state.train.loss * 100)} />
                                        </Row>
                                    </Col>
                                }
                                {this.state.trainSaveMode &&
